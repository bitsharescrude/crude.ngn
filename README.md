...
# HOW IT WORKS
The issuer or (designated outlets) will operate like a blockchain-teller helping local crypto-traders/users with Crude-Naira liquidity for their Naira at lower costs. These local users will bid for their favourite cryptocurrencies with their CRUDE.NGN. As long as the owner can back the supply of the CRUDE.NGN with BTS/USDT he will not run out of service.
